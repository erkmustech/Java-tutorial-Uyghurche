...
public class Ques_29 {
	...
	public static void main(String[] args) {
		/*
		 Write a function that accepts an array. For each multiple of 10 in the given array, change all the 
		 values following it to be that multiple of 10, until encountering another multiple of 10.
